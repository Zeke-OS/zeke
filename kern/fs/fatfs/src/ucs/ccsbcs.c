...
const WCHAR fatfs_ccsbcs_tbl_437[] = {
...
const WCHAR fatfs_ccsbcs_tbl_720[] = {
...
const WCHAR fatfs_ccsbcs_tbl_737[] = {
...
const WCHAR fatfs_ccsbcs_tbl_775[] = {
...
const WCHAR fatfs_ccsbcs_tbl_850[] = {
    0x00C7, 0x00FC, 0x00E9, 0x00E2, 0x00E4, 0x00E0, 0x00E5, 0x00E7,
    0x00EA, 0x00EB, 0x00E8, 0x00EF, 0x00EE, 0x00EC, 0x00C4, 0x00C5,
    0x00C9, 0x00E6, 0x00C6, 0x00F4, 0x00F6, 0x00F2, 0x00FB, 0x00F9,
...
const WCHAR fatfs_ccsbcs_tbl_852[] = {
...
const WCHAR fatfs_ccsbcs_tbl_855[] = {
...
const WCHAR fatfs_ccsbcs_tbl_857[] = {
    0x00C7, 0x00FC, 0x00E9, 0x00E2, 0x00E4, 0x00E0, 0x00E5, 0x00E7,
...
const WCHAR fatfs_ccsbcs_tbl_858[] = {
    0x00C7, 0x00FC, 0x00E9, 0x00E2, 0x00E4, 0x00E0, 0x00E5, 0x00E7,
    0x00EA, 0x00EB, 0x00E8, 0x00EF, 0x00EE, 0x00EC, 0x00C4, 0x00C5,
    0x00C9, 0x00E6, 0x00C6, 0x00F4, 0x00F6, 0x00F2, 0x00FB, 0x00F9,
    0x00FF, 0x00D6, 0x00DC, 0x00F8, 0x00A3, 0x00D8, 0x00D7, 0x0192,
...
const WCHAR fatfs_ccsbcs_tbl_862[] = {
...
const WCHAR fatfs_ccsbcs_tbl_866[] = {
...
const WCHAR fatfs_ccsbcs_tbl_874[] = {
...
const WCHAR fatfs_ccsbcs_tbl_1250[] = {
...
const WCHAR fatfs_ccsbcs_tbl_1251[] = {
...
const WCHAR fatfs_ccsbcs_tbl_1252[] = {
...
const WCHAR fatfs_ccsbcs_tbl_1253[] = {
    0x20AC, 0x0000, 0x201A, 0x0192, 0x201E, 0x2026, 0x2020, 0x2021,
...
const WCHAR fatfs_ccsbcs_tbl_1254[] = {
...
const WCHAR fatfs_ccsbcs_tbl_1255[] = {
    0x20AC, 0x0000, 0x201A, 0x0192, 0x201E, 0x2026, 0x2020, 0x2021,
...
const WCHAR fatfs_ccsbcs_tbl_1256[] = {
...
const WCHAR fatfs_ccsbcs_tbl_1257[] = {
    0x20AC, 0x0000, 0x201A, 0x0000, 0x201E, 0x2026, 0x2020, 0x2021,
...
const WCHAR fatfs_ccsbcs_tbl_1258[] = {
    0x20AC, 0x0000, 0x201A, 0x0192, 0x201E, 0x2026, 0x2020, 0x2021,
...
WCHAR fatfs_ccsbcs_wtoupper( /* Upper converted character */
