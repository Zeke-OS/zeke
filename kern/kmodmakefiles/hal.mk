...
ifeq ($(configMCU_MODEL),MCU_MODEL_BCM2835)
	...
	hal-SRC-1 += kern/hal/bcm2835/bcm2835_gpio.c
	hal-SRC-1 += kern/hal/bcm2835/bcm2835_timers.c
	hal-SRC-$(configBCM_MB) += kern/hal/bcm2835/bcm2835_mailbox.c
	...
	hal-SRC-$(configRPI_LEDS) += $(wildcard kern/hal/rpi/rpi_leds.c)
endif
