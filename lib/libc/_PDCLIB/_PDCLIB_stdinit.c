...
static FILE _PDCLIB_serr = {
    ...
    .bufsize    = sizeof(_PDCLIB_serr_buffer),
    .bufidx     = 0,
    .bufend     = 0,
    .ungetidx   = 0,
...
static FILE _PDCLIB_sout = {
    ...
    .bufsize    = sizeof(_PDCLIB_sout_buffer),
    .bufidx     = 0,
    .bufend     = 0,
    .ungetidx   = 0,
...
static FILE _PDCLIB_sin  = {
    ...
    .bufsize    = sizeof(_PDCLIB_sin_buffer),
    .bufidx     = 0,
    .bufend     = 0,
    .ungetidx   = 0,
...
struct _PDCLIB_locale _PDCLIB_global_locale = {
    ...
    ._ErrnoStr = {
        ...
        /* ESTALE */ (char *)"ESTALE (Stale file handle)",
        /* !RESERVED! */ (char *)"",
        /* ETIMEDOUT */ (char *)"ETIMEDOUT (Connection timed out)",
        /* ETXTBSY */ (char *)"ETXTBSY (Text file busy)",
        /* EXDEV */ (char *)"EXDEV (Cross-device link or Improper link)",
        /* ENOTBLK */ (char *)"ENOTBLK (Block device required)",
    },
};
